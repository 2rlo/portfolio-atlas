...
function ScheduleProductView({ fixture, activeId, onActivate }: ScheduleProductViewProps) {
  return (
    <section className="schedule-product" data-has-active={activeId ? 'true' : 'false'} aria-label={`${fixture.productName} 일정 공개 재구성 화면`}>
        ...
        <div className="schedule-product-canvas">
          ...
          <div className="schedule-workspace">
            <div className="schedule-main">
              <ProductHotspot id="canonical-timeline" activeId={activeId} label="확정 계획과 실제 진행 타임라인" className="schedule-timeline" onActivate={onActivate}>
              ...
              <ProductHotspot id="missing-data" activeId={activeId} label="누락 상태를 표시한 일정 데이터" className="schedule-plan-table" onActivate={onActivate}>
            ...
            <ProductHotspot id="staged-changes" activeId={activeId} label="검토 대기 중인 일정 변경안" className="schedule-change-rail" onActivate={onActivate}>
          ...
          <ProductHotspot id="audit-revert" activeId={activeId} label="추가 전용 적용 이력과 되돌리기 조건" className="schedule-audit-strip" onActivate={onActivate}>
          ...
          <ProductHotspot id="role-boundary" activeId={activeId} label="공유 일정의 조회 전용 권한 범위" className="schedule-role-strip" onActivate={onActivate}>
