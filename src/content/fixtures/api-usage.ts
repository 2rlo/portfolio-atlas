...
export const apiUsageProductFixture = {
  ...
  syntheticSummary: [
    { label: 'TODAY', value: '$1.12', note: '$2.00부터 경고', tone: 'normal' },
    { label: 'LAST 7 DAYS', value: '$18.40', note: '기록된 사용량', tone: 'normal' },
    { label: 'THIS MONTH', value: '$43.20', note: '활성일 26일', tone: 'normal' },
    { label: 'MONTH-END', value: '$61.80', note: '월말 예상액 · 청구액 아님', tone: 'warning' },
  ],
  guard: {
